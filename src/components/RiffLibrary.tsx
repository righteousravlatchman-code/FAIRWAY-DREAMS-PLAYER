...
import { Play, Square, Save, Trash2, Headphones, Activity, Music, Share2, Tag, Calendar } from 'lucide-react';
                ...
                {filteredRiffs.length === 0 ? (
                  ...
                  filteredRiffs.map(riff => (
                    <motion.div
                      ...
                      className="group p-4 bg-black/40 border border-white/10 hover:border-gold/30 rounded-2xl backdrop-blur-xl transition-all flex flex-col md:flex-row gap-4 items-start md:items-center justify-between"
                    >
